...
function _getDimensions(device, orientation) {
    return {
        deviceWidth: orientation === "portrait" ? device.viewPort.portrait.width : device.viewPort.landscape.width,
        deviceHeight: orientation === "portrait" ? device.viewPort.portrait.height : device.viewPort.landscape.height,
