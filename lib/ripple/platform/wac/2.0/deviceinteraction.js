...
module.exports = _self = {
    ...
    startNotify : function (onSuccess, onError, duration) {
        return validate.validateTypeMismatch(onSuccess, onError, "startNotify", function () {
            if (!isMute()) {
    ...
    startVibrate : function (onSuccess, onError, duration, pattern) {       
        return validate.validateTypeMismatch(onSuccess, onError, "startVibrate", function () {
            if (pattern) {
    ...
    lightOn : function (onSuccess, onError, duration) {
        return validate.validateTypeMismatch(onSuccess, onError, "lightOn", function () {
            if (isBacklightOn()) {
                if (onError) {
                    setTimeout(function () {
                        onError(new DeviceApiError(errorcode.UNKNOWN_ERR));
    ...
    setWallpaper : function (onSuccess, onError, fileName) {
        ...
        return validate.validateTypeMismatch(onSuccess, onError, "setWallpaper", function () {
            return pendingOperation(function () {
