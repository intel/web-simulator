...
VehiclePropertyType = function (propertyTypes) {
    ...
    this.__defineSetter__("time", function (val) {
        try {
            vehiclePropertyType.time = t["unsigned long long"](val);
        }
        catch (err) {
        }
    });
...
VehicleSpeed = function (propertyTypes) {
    ...
    this.__defineSetter__("vehicleSpeed", function (val) {
        try {
            vehicleSpeed.vehicleSpeed = t["unsigned long"](val);
        }
        catch (err) {
        }
    });
...
EngineSpeed = function (propertyTypes) {
    ...
    this.__defineSetter__("engineSpeed", function (val) {
        try {
            engineSpeed.engineSpeed = t["unsigned long"](val);
        }
        catch (err) {
        }
    });
...
TripMeter = function (propertyTypes) {
    ...
    this.__defineSetter__("tripMeters", function (val) {
        ...
        //Changing any items in the array will reset the item's value to '0';
            tripMeter.tripMeters = t["unsigned long"](val, "[]");
        }
        catch (err) {
        }
    });
...
Acceleration = function (propertyTypes) {
    ...
    this.__defineSetter__("x", function (val) {
        try {
            acceleration.x = t["unsigned long"](val, "[]");
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("y", function (val) {
        try {
            acceleration.y = t["unsigned long"](val, "[]");
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("z", function (val) {
        try {
            acceleration.z = t["unsigned long"](val, "[]");
        }
        catch (err) {
        }
    });
...
CruiseControlStatus = function (propertyTypes) {
    ...
    this.__defineSetter__("speed", function (val) {
        try {
            cruiseControlStatus.speed = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
...
Fuel = function (propertyTypes) {
    ...
    this.__defineSetter__("level", function (val) {
        try {
            fuel.level = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("range", function (val) {
        try {
            fuel.range = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("instantConsumption", function (val) {
        try {
            fuel.instantConsumption = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("instantEconomy", function (val) {
        try {
            fuel.instantEconomy = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("averageEconomy", function (val) {
        try {
            ...
            fuel.averageEconomy = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
...
EngineOil = function (propertyTypes) {
    ...
    this.__defineSetter__("remaining", function (val) {
        try {
            engineOil.remaining = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("pressure", function (val) {
        try {
            engineOil.pressure = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
...
ExteriorBrightness = function (propertyTypes) {
    ...
    this.__defineSetter__("exteriorBrightness", function (val) {
        try {
            eb.exteriorBrightness = t["unsigned long"](val);
        }
        catch (err) {
        }
    });
...
DefrostDictionary = function (defrostDictionary) {
    this.window = defrostDictionary.window || 0;
    this.defrost = defrostDictionary.defrost || false;
};
...
WindowStatusDictionary = function (windowStatusDictionary) {
    this.windowlocation = windowStatusDictionary.windowlocation || 0;
    this.percentage = windowStatusDictionary.percentage || 0;
}
...
WindowStatus = function (propertyTypes) {
    ...
    windowStatus.WindowStatus = new WindowStatusDictionary (propertyTypes.WindowStatus);
    ...
    this.__defineSetter__("WindowStatus", function (val) {
        try {
            windowStatus.WindowStatus = t.WindowStatusDictionary(val);
        }
        catch (err) {
        }
    });
...
Sunroof = function (propertyTypes) {
    ...
    this.__defineSetter__("openness", function (val) {
        try {
            sunroof.openness = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("tilt", function (val) {
        try {
            sunroof.tilt = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
...
ConvertibleRoof = function (propertyTypes) {
    ...
    this.__defineSetter__("openness", function (val) {
        try {
            convertibleRoof.openness = t["unsigned short"](val);
        }
        catch (err) {
        }
    });
...
Size = function (propertyTypes) {
    ...
    this.__defineSetter__("width", function (val) {
        try {
            size.width = t["unsigned long"](val);
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("height", function (val) {
        try {
            size.height = t["unsigned long"](val);
        }
        catch (err) {
        }
    });
    ...
    this.__defineSetter__("length", function (val) {
        try {
            size.length = t["unsigned long"](val);
        }
        catch (err) {
        }
    });
...
_self = function () {
    ...
    function supported () {
        var supportedTypes = {types: null};

        if (!_security.supported) {
            throw new WebAPIException(errorcode.PERMISSION_DENIED);
        }

        event.trigger("vehicle-supported-properties", [supportedTypes], true);
    ...
    function get (property, zone) {
        ...
        propertyObj = {attr: [property, zone], val: null, supported: false};

        event.trigger("vehicle-get-property", [propertyObj], true);
        if (! propertyObj.supported) {
            throw new WebAPIException(errorcode.PROPERTY_UNAVAILABLE);
        }

        return propertyObj.val;
    }
    ...
    function set (property, value, errorCallback) {
        ...
        window.setTimeout(function () {
            ...
            event.trigger("vehicle-set-request", [property, value]);
        }, 1);
    }
