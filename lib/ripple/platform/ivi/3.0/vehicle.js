...
_self = function () {
    ...
    function supported () {
        ...
        event.trigger("vehicle-supported-request", [sup], true);

        return sup.properties;
    }
    ...
    function get (property, zone) {
        ...
        propertyObj.zone = zone;

        event.trigger("vehicle-get-request", [propertyObj], true);

        return new VehicleFactory(propertyObj.type, propertyObj.property);
    }
    ...
    function set (property, value, errorCallback) {
        var val = utils.copy(value), propertyObj = {};
        ...
        propertyObj.error = false;

        event.trigger("vehicle-set-request", [propertyObj], false);

        if (propertyObj.error) {
...
/*function _initialize() {
    var vehicleDB = db.retrieveObject("ivi-vehicle-database"),
        time, data, property;
