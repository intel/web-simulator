...
_self = function () {
    ...
    this.__defineGetter__("onserverfound", function () {
        return mediaserver.onserverfound;
    });
    
    this.__defineSetter__("onserverfound", function (val) {
        try {
            mediaserver.onserverfound = t.Callback(val, "?");
        } catch (e) {
        }
    });
