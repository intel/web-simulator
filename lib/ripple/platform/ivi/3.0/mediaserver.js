...
_self = function () {
    ...
    function scanNetwork(errorCallback) {
    ...
    mediaserver.__defineGetter__("onserverfound", function () {
        return _data.mediaServer.onserverfound;
    });
    
    mediaserver.__defineSetter__("onserverfound", function (val) {
        try {
            _data.mediaServer.onserverfound = t.Callback(val, "?");
        } catch (e) {
        }
    });
