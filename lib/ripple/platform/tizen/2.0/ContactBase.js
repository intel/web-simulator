...
Contact = function () {
    ...
    function construct() {
        ...
        this.__defineGetter__("personId", function () {
            return null;
        });
    ...
    function clone(obj) {
        return function () {
            var duplicate = new Contact(), attr,
                ignoreProp = ["id", "personId", "addressBookId", "lastUpdated",
                        "isFavorite"];
            ...
            for (attr in obj) {
                if ((ignoreProp.indexOf(attr) === -1) &&
                    ...
                    duplicate[attr] = utils.copy(obj[attr]);
                }
            }
