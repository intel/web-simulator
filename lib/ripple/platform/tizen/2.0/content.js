...
function _defaultContent() {
    var video1 = {
        editableAttributes: ["title", "description", "rating", "geolocation", "album", "artists"],
    ...
    video2 = {
        editableAttributes: ["title", "description", "rating", "album"],
        id:                 Math.uuid(null, 16),
        name:               "galaxy.rmvb",
        type:               "VIDEO",
        mimeType:           "video/x-msvideo",
    ...
    audio1 = {
        editableAttributes: ["title", "description", "rating", "album", "genres", "artists", "composers"],
        id:                 Math.uuid(null, 16),
        name:               "rock.mp3",
        type:               "AUDIO",
    ...
    audio2 = {
        editableAttributes: ["title", "description", "rating", "album", "artists"],
        id:                 Math.uuid(null, 16),
        name:               "jazz.acc",
        type:               "AUDIO",
        mimeType:           "audio/x-msaudio",
    ...
    image1 = {
        editableAttributes: ["title", "description", "rating", "geolocation", "orientation"],
        id:                 Math.uuid(null, 16),
        name:               "greatwall.jpg",
        type:               "IMAGE",
        mimeType:           "image/jpeg",
    ...
    image2 = {
        editableAttributes: ["title", "rating", "orientation"],
        id:                 Math.uuid(null, 16),
        name:               "seagull.gif",
        type:               "IMAGE",
        mimeType:           "image/gif",
