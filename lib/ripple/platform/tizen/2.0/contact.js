...
_self = function () {
    ...
    function getAddressBooks(successCallback, errorCallback) {
        ...
        if (!_security.all && !_security.getAddressBooks) {
    ...
    function getDefaultAddressBook() {
        if (!_security.all && !_security.getDefaultAddressBook) {
            throw new WebAPIException(errorcode.SECURITY_ERR);
        }
        if (_data.addressBooks.length === 0) {
            loadAddressBooks();
    ...
    function getAddressBook(addressBookId) {
        ...
        if (!_security.all && !_security.getAddressBook) {
            throw new WebAPIException(errorcode.SECURITY_ERR);
        }
        if (!(new TypeCoerce(t.AddressBookId)).match(addressBookId)) {
    ...
    function get(personId) {
        ...
        if (!(new TypeCoerce(t.PersonId)).match(personId)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (!personId) {
    ...
    function update(person) {
        ...
        if (!(new TypeCoerce(t.Person)).match(person)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (!person.id) {
            throw new WebAPIException(errorcode.INVALID_VALUES_ERR);
    ...
    function updateBatch(persons, successCallback, errorCallback) {
        ...
        if (!(new TypeCoerce([t.Person])).match(persons)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
    ...
    function removeBatch(personIds, successCallback, errorCallback) {
        ...
        if (!(new TypeCoerce([t.PersonId])).match(personIds)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (successCallback && !(new TypeCoerce(t.SuccessCallback)).match(successCallback)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
    ...
    function find(successCallback, errorCallback, filter, sortMode) {
        function _find() {
            ...
            if (sortMode && !(new TypeCoerce(t.SortMode)).match(sortMode)) {
                throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
            }
    ...
    function addChangeListener(successCallback) {
        ...
        if (!(new TypeCoerce(t.PersonsChangeCallback)).match(successCallback)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
...
AddressBook = function (id, name, readOnly, dbContacts, dbGroups) {
    ...
    function get(id) {
        ...
        if (!(new TypeCoerce(t.ContactId)).match(id)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (!id) {
            throw new WebAPIException(errorcode.INVALID_VALUES_ERR);
    ...
    function add(contact) {
        ...
        if (!(new TypeCoerce(t.Contact)).match(contact)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
    ...
    function addBatch(contacts, successCallback, errorCallback) {
        ...
        if (!(new TypeCoerce([t.Contact])).match(contacts)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (successCallback && !(new TypeCoerce(t.ContactArraySuccessCallback)).match(successCallback)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (errorCallback && !(new TypeCoerce(t.ErrorCallback)).match(errorCallback)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
    ...
    function removeBatch(ids, successCallback, errorCallback) {
        ...
        if (!(new TypeCoerce([t.ContactId])).match(ids)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (successCallback && !(new TypeCoerce(t.SuccessCallback)).match(successCallback)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
    ...
    function addChangeListener(successCallback, errorCallback) {
        ...
        if (!(new TypeCoerce(t.AddressBookChangeCallback)).match(successCallback)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (errorCallback && !(new TypeCoerce(t.ErrorCallback)).match(errorCallback)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
    ...
    function getGroup(groupId) {
        ...
        if (!_security.all && !_security.getGroup) {
            throw new WebAPIException(errorcode.SECURITY_ERR);
        }
        if (!(new TypeCoerce(t.ContactGroupId)).match(groupId)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (!groupId) {
            throw new WebAPIException(errorcode.INVALID_VALUES_ERR);
    ...
    function addGroup(group) {
        ...
        if (!(new TypeCoerce(t.ContactGroup)).match(group)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
...
ContactPublic = function (prop) {
    ...
    if (!(new TypeCoerce(t.ContactId)).match(prop.id)) {
        return undefined;
    }
    if (!(new TypeCoerce(t.Date)).match(prop.lastUpdated)) {
        return undefined;
    }
...
Person = function (personInitDict) {
    ...
    this.unlink = function (contactId) {
        ...
        if (!(new TypeCoerce(t.ContactId)).match(contactId)) {
            throw new WebAPIException(errorcode.TYPE_MISMATCH_ERR);
        }
        if (!contactId) {
            throw new WebAPIException(errorcode.INVALID_VALUES_ERR);
