...
_self = function (pattern) {
    ...
    function isInstance(pattern, obj) {
        var attr;
    ...
    function cast(obj) {
        ...
        typeMap = {
            ...
            "Object": function () {
                var attr, derived, i, isMatched = false;
                ...
                for (attr in pattern) {
                    ...
                    case "_derived":
                        for (i in pattern._derived) {
                            if (isInstance(pattern._derived[i], obj)) {
                                isMatched = true;
                                break;
                            }
                        }
                        derived = _self(pattern._derived[isMatched ? i : 0])
                            .cast(obj);
                        for (i in derived) {
                            obj[i] = derived[i];
                        }
            ...
            "float": function () {
                return isFinite(Number(obj)) ? Number(obj) : 0;
            },
