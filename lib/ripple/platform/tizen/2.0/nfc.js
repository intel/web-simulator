...
var db = require('ripple/db'),
    ...
    _security = {
        "http://tizen.org/privilege/nfc.common": ["getCachedMessage"],
        "http://tizen.org/privilege/nfc.admin": ["setPowered", "setCardEmulation"],
        "http://tizen.org/privilege/nfc.tag": ["setTagListener", "unsetTagListener"],
        "http://tizen.org/privilege/nfc.p2p": ["setPeerListener", "unsetPeerListener"],
