...
_self = {
    ...
    connectService: function (notificationCallback) {
        var appId, appService;

        if (!_security.all && !_security.connectService) {
            throw new WebAPIException(errorcode.SECURITY_ERR);
        }
    ...
    disconnectService: function () {
        ...
        if (!_security.all && !_security.disconnectService) {
            throw new WebAPIException(errorcode.SECURITY_ERR);
        }
    ...
    getRegistrationId: function () {
        ...
        if (!_security.all && !_security.getRegistrationId) {
            throw new WebAPIException(errorcode.SECURITY_ERR);
        }
