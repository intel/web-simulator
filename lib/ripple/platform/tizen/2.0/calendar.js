...
Calendar = function (type, name, storageItems, id) {
    ...
    function loadCalendarItemInit(calendarItem, storageItem) {
        ...
        calendarItem.startDate = stroageItem.startDate;
        if (storageItem.startDate instanceof tizen.TZDate) {
    ...
    function loadCalendarEventInit(calendarItem, storageItem) {
        ...
        calendarItem.endDate = stroageItem.endDate;
        if (storageItem.endDate instanceof tizen.TZDate) {
        ...
        calendarItem.untilDate = stroageItem.untilDate;
        if (storageItem.untilDate instanceof tizen.TZDate) {
    ...
    function loadCalendarTaskInit(calendarItem, storageItem) {
        ...
        calendarItem.dueDate = stroageItem.dueDate;
        if (storageItem.dueDate instanceof tizen.TZDate) {
        ...
        calendarItem.completeDate = stroageItem.completeDate;
        if (storageItem.completeDate instanceof tizen.TZDate) {
    ...
    function loadCalendarItems() {
        ...
        for (i in storageItems) {
            calendarItem = new CalendarItem(type, i, storageItems[i].lastModificationDate?TZDate(new Date(storageItems[i].lastModificationDate)):null, _security);
