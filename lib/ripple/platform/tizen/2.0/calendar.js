...
Calendar = function (type, name, storageItems, id) {
    ...
    function loadCalendarEventInit(calendarItem, storageItem) {
        ...
        calendarItem.untilDate       = storageItem.untilDate ? storageItem.untilDate.addDuration(new TDur(0, "MSECS")):storageItem.untilDate;
    ...
    function loadCalendarTaskInit(calendarItem, storageItem) {
        ...
        calendarItem.completedDate = storageItem.completedDate ? storageItem.completedDate.addDuration(new TDur(0, "MSECS")):storageItem.completedDate;
    ...
    function loadCalendarItems() {
        ...
        for (i in storageItems) {
            calendarItem = new CalendarItem(type, i, storageItems[i].lastModificationDate.addDuration(new TDur(0, "MSECS")), _security);
