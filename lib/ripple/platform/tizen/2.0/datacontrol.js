...
_self = function () {
    ...
    function getDataControlConsumer(providerId, dataId, type) {
        ...
        providerId = t.DOMString(providerId);
        dataId = t.DOMString(dataId);
...
SQLDataControlConsumer = function (providerId, dataId, dc) {
    ...
    function insert(reqId, insertionData, successCallback, errorCallback) {
        ...
        reqId = t["unsigned long"](reqId);
        insertionData = t.RowData(insertionData);
        successCallback = t.DataControlInsertSuccessCallback(successCallback,
                "?");
        errorCallback = t.DataControlErrorCallback(errorCallback, "?");
    ...
    function update(reqId, updateData, where, successCallback, errorCallback) {
        ...
        reqId = t["unsigned long"](reqId);
        updateData = t.RowData(updateData);
        where = t.DOMString(where);
        successCallback = t.DataControlSuccessCallback(successCallback, "?");
        errorCallback = t.DataControlErrorCallback(errorCallback, "?");
    ...
    function select(reqId, columns, where, successCallback, errorCallback, page,
        ...
        reqId = t["unsigned long"](reqId);
        columns = t.DOMString(columns, "[]");
        where = t.DOMString(where);
        successCallback = t.DataControlSelectSuccessCallback(successCallback);
        errorCallback = t.DataControlErrorCallback(errorCallback, "?");
        page = t["unsigned long"](page, "?");
        maxNumberPerPage = t["unsigned long"](maxNumberPerPage, "?");
...
MappedDataControlConsumer = function (providerId, dataId, dc) {
    ...
    function getValue(reqId, key, successCallback, errorCallback) {
        ...
        reqId = t["unsigned long"](reqId);
        key = t.DOMString(key);
        successCallback = t.DataControlGetValueSuccessCallback(successCallback);
        errorCallback = t.DataControlErrorCallback(errorCallback, "?");
    ...
    function updateValue(reqId, key, oldValue, newValue, successCallback,
        ...
        reqId = t["unsigned long"](reqId);
        key = t.DOMString(key);
        oldValue = t.DOMString(oldValue);
        newValue = t.DOMString(newValue);
        successCallback = t.DataControlSuccessCallback(successCallback);
        errorCallback = t.DataControlErrorCallback(errorCallback, "?");
