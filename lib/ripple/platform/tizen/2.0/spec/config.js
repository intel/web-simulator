...
module.exports = {
    ...
    extractInfo: function (configValidationObject) {
        ...
        widgetInfo.features = {};
        contentOrientation = configValidationObject.widget.children.setting.validationResult[0].attributes["screen-orientation"].value;
        db.save("layout", contentOrientation);
