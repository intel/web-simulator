...
_t = {
    ...
    // Power
    PowerResource:                      ["SCREEN", "CPU"],
    PowerScreenState:                   ["SCREEN_OFF", "SCREEN_DIM",
                                         "SCREEN_NORMAL"],
    PowerCpuState:                      ["CPU_AWAKE"],
    PowerState:                         ["SCREEN_OFF", "SCREEN_DIM",
                                         "SCREEN_NORMAL", "CPU_AWAKE"],
...
_t.ScreenStateChangeCallback = _t.Function;
...
_t.ReaderArraySuccessCallback = _t.Function;
_t.SEChangeListener = {
    onSEReady:    _t.Callback,
    onSENotReady: _t.Callback
};
_t.SessionSuccessCallback  = _t.Function;
_t.ChannelSuccessCallback  = _t.Function;
_t.TransmitSuccessCallback = _t.Function;
...
// PowerManager
_i.PowerManager.request = {
    0: _t.PowerResource,
    1: _t.PowerState
};

_i.PowerManager.release = {
    0: _t.PowerResource
};

_i.PowerManager.setScreenStateChangeListener = {
    0: _t.ScreenStateChangeCallback
};

_i.PowerManager.unsetScreenStateChangeListener = null;

_i.PowerManager.getScreenBrightness = null;

_i.PowerManager.setScreenBrightness = {
    0: _t.double
};

_i.PowerManager.isScreenOn = null;

_i.PowerManager.restoreScreenBrightness = null;

_i.PowerManager.turnScreenOn = null;

_i.PowerManager.turnScreenOff = null;
...
// SEService
_i.SEService.getReaders = {
    0: _t.ReaderArraySuccessCallback,
    1: _t.ErrorCallback,
...
_i.SEService.registerSEListener = {
    0: _t.SEChangeListener
};

_i.SEService.unregisterSEListener = {
    0: _t.unsigned_long
};

_i.SEService.shutdown = null;

// Reader
_i.Reader.openSession = {
    0: _t.SessionSuccessCallback,
    1: _t.ErrorCallback,
...
_i.Reader.getName = null;
_i.Reader.closeSessions = null;

// Session
_i.Session.openBasicChannel = {
    0: [_t.byte],
    1: _t.ChannelSuccessCallback,
    2: _t.ErrorCallback,
...
_i.Session.getATR = null;
_i.Session.close = null;
_i.Session.closeChannels = null;

// Channel
_i.Channel.transmit = {
    0: [_t.byte],
    1: _t.TransmitSuccessCallback,
    2: _t.ErrorCallback,
...
// WebSettingManager
_i.WebSettingManager.setUserAgentString = {
    0: _t.DOMString,
    1: _t.SuccessCallback,
    2: _t.ErrorCallback,
...
_i.WebSettingManager.removeAllCookies = {
    0: _t.SuccessCallback,
    1: _t.ErrorCallback,
