...
var utils = require('ripple/utils'),
    ...
    _security = {
        ...
        "http://tizen.org/privilege/bluetooth.gap": ["discoverDevices", "stopDiscovery", "getKnownDevices", "getDevice", "createBonding", "destroyBonding"],
        "http://tizen.org/privilege/bluetooth.spp": ["registerRFCOMMServiceByUUID", "connectToServiceByUUID", "unregister", "writeData", "readData", "close"],
        all: true
    },
    _self;
...
BluetoothAdapter = function (devName, devAddress) {
    ...
    function setName(name, successCallback, errorCallback) {
        ...
        if (!_devPowered) {
            if (errorCallback) {
                errorCallback(new WebAPIError(errorcode.SERVICE_NOT_AVILABLE_ERR));
            }
            return;
        }
