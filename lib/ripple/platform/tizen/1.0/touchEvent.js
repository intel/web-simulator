    ...
    mask: function (frame) {
        frame.contentWindow.addEventListener("DOMContentLoaded", function () {
            var widgetDocument = frame.contentDocument,
                getElement = widgetDocument.getElementById;

            widgetDocument.getElementById = function () {
                var element = getElement.apply(widgetDocument, Array.prototype.slice.call(arguments)),
                ...
                element.addEventListener = function (event, callback, useCapture) {
                    ...
                    add.apply(element, arguments);
                };
                return getElement.apply(widgetDocument, Array.prototype.slice.call(arguments));
            };
