...
NFCAdapter = function () {
	...
	if((typeof detectCallback !=="object") || 
	 (typeof detectCallback.onattach !=="function") ||
	 (typeof detectCallback.ondettach !=="function")){
	   return new WebAPIError(errorcode.TYPE_MISMATCH_ERR);
	}else{
...
NFCTag = function (type, isSupportedNDEF, ndefSize, properties, isConnected) {
    ...
    function readNDEF(readCallback, errorCallback) {
        function _readNDEF() {
            ...
            readCallback(Utils.copy(_data.ndefMessage));
        }
    ...
    function writeNDEF(ndefMessage, successCallback, errorCallback) {
        ...
        _data.ndefMessage = Utils.copy(ndefMessage);
