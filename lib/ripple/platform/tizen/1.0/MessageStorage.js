    ...
    message_storage = {
        addDraftMessage: function (_msg, onSuccess, onError) {
            ...
            if (_security_check.write === false) {
                throw (new CommonError("PERMISSION_DENIED_ERROR"));
            }
            ...
            return tizen1_utils.validateTypeMismatch(onSuccess, onError, "messagingStorage:addDraftMessage", _addDraft);
        },
        ...
        removeMessages: function (messages, onSuccess, onError) {
            ...
            _removeMsg = function () {
                ...
                if (na_msg === "") {
                    ...
                    if (onError) {
                        setTimeout(function () {
                            onError(new CommonError("NOT_FOUND_ERROR",
                                    na_msg + "not found !!"));
                        }, 1);
                    }
                }
            };
            return tizen1_utils.validateTypeMismatch(onSuccess, onError, "messagingStorage:removeMessage", _removeMsg);
        },
        ...
        updateMessages: function (messages, onSuccess, onError) {
                ...
                for (i = 0; i < messages.length; i++) {
                    ...
                    if (m.priv.messageStatus === "DRAFT") {
                        ...
                        if (typeof messages[i].isRead === 'boolean') {
                            m.priv.isRead = messages[i].isRead;
                            updateMsg.push(m);
            ...
            return tizen1_utils.validateTypeMismatch(onSuccess, onError, "messagingStorage:updateMessage", _updateMsg);
        },
        ...
        findMessages: function (filter, onSuccess, onError, sort, _limit, _offset) {
            ...
            return tizen1_utils.validateTypeMismatch(onSuccess, onError,
                       "messagingStorage:findMessages", _findMsg);
        },
        ...
        findConversations: function (filter, onSuccess, onError, sort, _limit, _offset) {
            ...
            return tizen1_utils.validateTypeMismatch(onSuccess, onError,
                       "messagingStorage:findConversations", _findConv);
        },
        ...
        removeConversations: function (conversations, onSuccess, onError) {
            ...
            return tizen1_utils.validateTypeMismatch(onSuccess, onError, "messagingStorage:removeConversations", _removeConv);
        },
        ...
        findFolders: function (filter, onSuccess, onError) {
            ...
            return tizen1_utils.validateTypeMismatch(onSuccess, onError,
                       "messagingStorage:findFolders", _findFolders);
        },
        ...
        removeChangeListener: function (watchid) {
            ...
            throw (new CommonError("NOT_FOUND_ERROR"));
        }
