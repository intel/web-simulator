...
_self = {
    ...
    GeoCoordinates : function (prop) {
        ...
        /* if error occurs during checking, _self is an empyt object.
        So I randomly pick latitude to check if property check fails */
        if (_self.latitude === undefined)
            return undefined;
    ...
    StructuredAddress : function (prop) {
        ...
        /* if error occurs during checking, _self type is undefined */
        if (_self === undefined)
            return undefined;
