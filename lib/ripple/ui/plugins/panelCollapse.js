...
$(function(){
    $(window).resize(function(){
        ...
        jQuery(".PanelCollapseBar").css("top", windowHeight-10-46);
...
function _process(collapseNode, panelNode, side, callback) {
	var deviceNode = jQuery(_MIDDLE_PANEL);
    ...
    if (_store[side] === true) {
		...
		if (side === "left") {
			...
			collapseNode.css("top", $(window).height()-10-46);
			collapseNode.css("left", 0);
			deviceNode.css("left", "50%");
		}
    ...
    initialize: function () {
        ...
        if (_store.left === true) {
            ...
            */
			...
			leftCollapseNode.css("top", $(window).height()-10-46);
			leftCollapseNode.css("left", 0);
        	deviceNode.css("left", "50%");
        }	
