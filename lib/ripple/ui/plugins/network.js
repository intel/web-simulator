...
function _initializeElements() {
    jQuery(function () {
        ...
        if (deviceSettings.retrieve("CellularNetwork.status") === true) {
        ...
        $("#cellular-radio1").click(function () {
            deviceSettings.persist("CellularNetwork.status", true);
            event.trigger("CellularNetworkStatusChanged", [true]);
        });

        $("#cellular-radio2").click(function () {
            deviceSettings.persist("CellularNetwork.status", false);
