...
function _initializeElements() {
    jQuery(function () {
        ...
        if (deviceSettings.retrieve("WifiNetwork.status") === "true") {
        ...
        $("#network-type1").prop('checked', false);
        $("#network-type2").prop('checked', false);
        $("#network-type3").prop('checked', false);
        if (deviceSettings.retrieve("Network.networkType") === "2G") {
            $("#network-type1").prop('checked', true);
        }
        else if (deviceSettings.retrieve("Network.networkType") === "3G") {
            $("#network-type2").prop('checked', true);
        }
        else {
            $("#network-type3").prop('checked', true);
        }
        $("#network-type1").button("refresh");
        $("#network-type2").button("refresh");
        $("#network-type3").button("refresh");
