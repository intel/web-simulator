...
module.exports = {
    ...
    initialize: function () {
        ...
        _dbBluetooth = dbinit.Bluetooth;
        utils.forEach(_dbBluetooth, function (item, index) {
        ...
        for (var address in _dbBluetooth) {
            _btSimulatedDevs[address] = _dbBluetooth[address];
            break;
        }
