...
var db = require('ripple/db'),
    ...
    _packages = {
        ...
        "/opt/usr/media/api1pack01.wgt": {
            id: "api1pack01", name: "tct-package-tizen-tests",
            iconPath: "tizen.png", version: "1.9",
            totalSize: 8264, dataSize: 50, author: "TizenDev",
            description: "This is a description which is used in tests.",
            appIds: ["api1appli1.TCTAppControl"]},
        ...
        "/opt/usr/media/testpack01.wgt": {
            id: "testpack01", name: "autoWebapiTizenPackageTestApplication",
            iconPath: "tizen.png", version: "5.5.5",
            totalSize: 8264, dataSize: 50, author: "TizenDev",
            description: "This is a description which is used in tests.",
            appIds: ["testpack01.testLaunch"]}
    },
    _installedList = {
        ...
        "api1pack01": {id: "api1pack01", name: "tct-package-tizen-tests",
            iconPath: "tizen.png", version: "1.9",
            totalSize: 8264, dataSize: 50, lastModified: new Date(),
            author: "TizenDev",
            description: "This is a description which is used in tests.",
        ...
        "testpack01": {id: "testpack01", name: "autoWebapiTizenPackageTestApplication",
            iconPath: "tizen.png", version: "5.5.5",
            totalSize: 8264, dataSize: 50, lastModified: new Date(),
            author: "TizenDev",
            description: "This is a description which is used in tests.",
