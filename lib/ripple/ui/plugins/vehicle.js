...
function _initializeProperties () {
    var i, inputHtml = "", tdHtml = "", tdNum = 0,
        ...
        properties = db.retrieveObject("bt-simulated-vehicle").properties,
        pro, realPro;
...
function _setSupportedProperties () {
    var supported = db.retrieveObject("bt-simulated-vehicle").supported, i,
...
function _initializePropertiesSetting () {
    var btVehicleDB = db.retrieveObject("bt-simulated-vehicle"),
        ...
        property, propertyItems, item, viewHtml = "";
...
function _initializeVehicleDomEvent () {
    ...
    jQuery(runSelector).bind("click", function () {
        ...
        if (this.innerHTML === "Stop") {
            ...
            jQuery(carSelector).attr("disabled", "disabled");
            ...
            jQuery(carSelector).removeAttr("disabled");
    ...
    jQuery(setSelector).bind("change", function () {
        ...
        property = propertyId.split("-")[0];
        type = propertyId.split("-")[1];
...
function _initializeVehicleEvent () {
    ...
    event.on("vehicle-subscribe-request", function (property, isInitial) {
        if (isInitial) {
