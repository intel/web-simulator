...
function flightModeChangedCB(value) {
    ...
    if (value === true) {
        ...
        deviceSettings.persist("CELLULAR_NETWORK.status", networkSettings['wifiSetting']);
        deviceSettings.persist("WIFI_NETWORK.status", networkSettings['cellularSetting']);
        document.getElementById("device-settings-WIFI_NETWORK-status").checked = networkSettings['cellularSetting'];
        document.getElementById("device-settings-CELLULAR_NETWORK-status").checked = networkSettings['wifiSetting'];
