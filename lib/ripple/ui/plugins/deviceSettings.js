...
function availCapacityCB(value) {
    if (value > 16000000000) value = 16000000000;
    if (value < 0) value = 0;
    if (document.getElementById("device-settings-STORAGE-availableCapacity").value === value) {
        return;
    }
    deviceSettings.persist("STORAGE.availableCapacity", Number(value));
    document.getElementById("device-settings-STORAGE-availableCapacity").value = value;
}
