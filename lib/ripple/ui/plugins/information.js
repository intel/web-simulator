...
function _updateInformationView() {
    ...
    if (widgetInfo.name) {
        infoList.push("<section><label class=\"ui-text-label\">App Name: </label><span class=\"text-is-selectable\">" + widgetInfo.name + "</span></section>");
        //Update Title
...
//    infoList.push("<tr><td><label class=\"ui-text-label\">Platform: </label></td><td>" + platform.current().name + "</td></tr>");
    ...
    infoList.push("<section><div style=\"clear:both;\"></div><label class=\"ui-text-label\">Home Screen Image: </label>" + _systemSettings["HOME_SCREEN"] + "</section>");
    infoList.push("<section><div style=\"clear:both;\"></div><label class=\"ui-text-label\">Lock Screen Image: </label>" + _systemSettings["LOCK_SCREEN"] + "</section>");
    infoList.push("<section><div style=\"clear:both;\"></div><label class=\"ui-text-label\">Incoming Call Number: </label>" + _systemSettings["INCOMING_CALL"] + "</section>");
    infoList.push("<section><div style=\"clear:both;\"></div><label class=\"ui-text-label\">Notification Email: </label>" + _systemSettings["NOTIFICATION_EMAIL"] + "</section>");
