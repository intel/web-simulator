...
/* 
	alarm.add()
	void add(Alarm alarm, ApplicationId applicationId, optional DOMString? argument);
...
/*
   ...
   ****
*/
	it("1. add an alarm to the storage", function () {
...
/*
   ...
   ****
*/
	it("2. add alarm - TYPE_MISMATCH_ERROR if any input parameter is not compatible with the expected type - alarm", function () {
		try {
			alarm.add("bla", "alarmclock");
		} catch (e) {
			runs(function () {
				expect(e.code).toEqual(errorcode.TYPE_MISMATCH_ERR);
			});
		}
	});
/*
   ...
   ****
*/
	it("3. add alarm - TYPE_MISMATCH_ERROR if any input parameter is not compatible with the expected type - applicationid", function () {
...
/*
   ...
   ****
*/
	it("4. add alarm - TYPE_MISMATCH_ERROR if any input parameter is not compatible with the expected type - arguments", function () {
		var alarm_a = new AlarmRelative(1 * alarm.PERIOD_MINUTE);
		try {
			alarm.add(alarm_a, "123", 123);
		} catch (e) {
			runs(function () {
				expect(e.code).toEqual(errorcode.TYPE_MISMATCH_ERR);
			});
...
/*
	...
	NOT_FOUND_ERROR name if this alarm identifier cannot be found in the storage.
  error code TYPE_MISMATCH_ERROR if any input parameter is not compatible with the expected type for that parameter.
*/
/*
   **** Test no 5
   ...
   ****
*/
	it("5. remove an alarm from the storage", function () {
		var alarms = [], length,
			alarm_a = new AlarmRelative(1 * alarm.PERIOD_MINUTE);
...
/*
   ...
   ****
*/
	it("6. remove alarm - NOT_FOUND_ERROR name if this alarm identifier cannot be found in the storage", function () {
		try {
			alarm.remove("unexisting_id");
		} catch (e) {
			runs(function () {
				expect(e.code).toEqual(errorcode.NOT_FOUND_ERROR);
			});
		}
	});
/*
   ...
   ****
*/
	it("7. remove alarm - TYPE_MISMATCH_ERROR if any input parameter is not compatible with the expected type", function () {
		var	err = function () {};
		try {
			alarm.remove(err);
		} catch (e) {
...
/*
   ...
   ****
*/
	it("8. Get an alarm from the storage", function () {
		var alarm_a = new AlarmRelative(1 * alarm.PERIOD_MINUTE);
		alarm.add(alarm_a, "alarmclock");
		runs(function () {
...
/*
   ...
   ****
*/
	it("9. Get alarm - NOT_FOUND_ERROR name if this alarm identifier cannot be found in the storage", function () {
...
/*
   ...
   ****
*/
	it("10. get alarm - TYPE_MISMATCH_ERROR if any input parameter is not compatible with the expected type", function () {
		var err = function () {};
		try {
			alarm.get(err);
		} catch (e) {
...
/*
	getAll
	Alarm[] getAll();
	Note that alarms that have already been triggered are removed automatically from the storage.
*/
...
/*
   ...
   ****
*/
	it("11. alarms that have already been triggered are removed automatically from the storage----1,AlarmRelative,expired", function () {
...
/*
   ...
   ****
*/
	it("12. alarms that have already been triggered are removed automatically from the storage----2,AlarmAbsolute,expired", function () {
		var current = new Date(), alarm_a = new AlarmAbsolute(current), alarms, length;
		alarm.add(alarm_a, "alarmclock");
		runs(function () {
			alarms = alarm.getAll();
			length = alarms.length;
...
/*
   ...
   ****
*/
	it("13. alarms that have already been triggered are removed automatically from the storage----3,AlarmAbsolute,not expired", function () {
...
/*
	removeAll
	removeAll();
	Removes all the alarms added by the application.
*/
/*
   **** Test no 14
...
/*
	Returns the duration before the next alarm trigger. 
	TimeDuration getRemainingDuration();
*/
...
/*
   ...
   ****
*/
	it("15.getRemainingSeconds returns the duration in seconds before the next alarm trigger", function () {
...
/*
   ...
   ****
*/
	it("16.getRemainingSeconds returns the duration in seconds before the next alarm trigger", function () {
...
/*
   ...
   ****
*/
	it("17. getRemainingSeconds returns the duration in seconds before the next alarm trigger", function () {
...
/*
   ...
   ****
*/
	it("18.getRemainingSeconds returns the duration in seconds before the next alarm trigger", function () {
		var alarm_a = new AlarmRelative(0.1 * alarm.PERIOD_MINUTE), real, expected;
		alarm.add(alarm_a, "alarmclock");
		waits(6000);
		runs(function () {
			real = alarm_a.getRemainingSeconds();
...
/*
   ...
   ****
*/
	it("19.getRemainingSeconds returns the duration in seconds before the next alarm trigger", function () {
		var alarm_a = new AlarmRelative(0.2 * alarm.PERIOD_MINUTE), real, expected;
		alarm.add(alarm_a, "alarmclock");
		waits(6000);
		runs(function () {
			real = alarm_a.getRemainingSeconds();
...
/*
   ...
   ****
*/
	it("20. create an AlarmAbsolute in different constructor", function () {
...
/*
   ...
   ****
*/
	it("21. new AlarmAbsolute (date, ByDayValue[] daysOfTheWeek); daysOfTheWeek TYPE_MISMATCH_ERROR", function () {
		try {
			var alarm_c = new AlarmAbsolute(today, ['1', 'FR']);
...
/*
   ...
   ****
*/
	it("22. new AlarmAbsolute (date, ByDayValue[] daysOfTheWeek); daysOfTheWeek TYPE_MISMATCH_ERROR", function () {
		try {
			var alarm_c = new AlarmAbsolute(today, ['', 'FR']);
...
/*
   ...
   ****
*/
	it("23. getNextScheduledDate(),no repeat,period === null,setTriggerDate has passed,return null", function () {
...
/*
   ...
   ****
*/
	it("24.getNextScheduledDate(),alarm.period === null,setTriggerDate has not passed,so return alarm.date", function () {
		var alarm_c = new AlarmAbsolute(tomorrow), nextTiggerDate, alarmlist;
		nextTiggerDate = alarm_c.getNextScheduledDate();
		...
		runs(function () {
            ...
            expect(alarm_c.period).toEqual(null);
			expect(alarm_c.daysOfTheWeek.length).toEqual(0);
			expect(nextTiggerDate).toEqual(tomorrow);
        });
	});
/*
   **** Test no 25
   ...
   ****
*/
	it("25. getNextScheduledDate(),period !== null, setTriggerDate has passed,return triggerTime", function () {
...
/*
   ...
   ****
*/
	it("26. getNextScheduledDate(),period !== null, setTriggerDate has not passed,return alarm.date", function () {
...
/*
   ...
   ****
*/
	it("27. getNextScheduledDate(),period = alarm.PERIOD_WEEK, return nextTriggerDate(perWeek),today between in daysOfTheWeek,after triggertime,return triggerDate", function () {
...
/*
   ...
   ****
*/
	it("29. getNextScheduledDate(),period = alarm.PERIOD_WEEK, return nextTriggerDate(perWeek),today is excluded from daysOfTheWeek", function () {
		var alarm_c, nextTriggerDate, triggerDate = today, day = today.getDay(), daysOfTheWeek = [];
...
/*
   ...
   ****
*/
	it("30. getNextScheduledDate(),period = alarm.PERIOD_WEEK, return nextTriggerDate(perWeek),today is excluded from daysOfTheWeek", function () {
		var alarm_c, nextTriggerDate, triggerDate = today, day = today.getDay(), daysOfTheWeek = [];
		//today is excluded from daysOfTheWeek
		daysOfTheWeek.push(_byDayValue[yesterday.getDay()]);//day-1
	...
	it("31. getNextScheduledDate(),period !== null, setTriggerDate has passed,return triggerTime", function () {
